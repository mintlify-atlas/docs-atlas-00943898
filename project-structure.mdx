...
description: "Understand how the mlops-fundamentals-homework monorepo is organized across three independent subsystems: data pipeline, model serving, and drift monitoring."
---
...
<CardGroup cols={2}>
  ...
  <Card title="CI/CD" icon="check-circle">
