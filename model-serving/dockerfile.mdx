...
description: "Extend the Dockerfile skeleton to bake the MLflow champion model into the image at build time so the inference container needs no MLflow server at runtime."
---
