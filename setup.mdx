---
title: "Set Up the MLOps Homework Environment"
sidebarTitle: "Setup"
description: "Install Python dependencies, configure environment variables, download the 550k Spotify Songs dataset from Kaggle, and verify DVC data integrity before running the pipeline."
---
...
<Steps>
  ...
  <Step title="Verify dataset integrity with DVC">
    ...
    <Note>
      The expected MD5 hash for the correct dataset file is **`0e71e2c46244acac485bd8c245aa6e56`**. After running `dvc repro`, check that the hash recorded in `dvc.lock` matches this value. A mismatch means you have a different version of the dataset and the grader's hash check will fail.
    </Note>
