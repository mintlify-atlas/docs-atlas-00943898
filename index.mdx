---
title: "MLOps Fundamentals Homework"
sidebarTitle: "Home"
description: "Build a production-ready end-to-end MLOps pipeline for Spotify genre classification — data versioning, experiment tracking, model serving, and drift monitoring."
---
...
<Steps>
  ...
  <Step title="CI/CD (1 pt)">
    Every push to your pull request triggers **GitHub Actions** — flake8 linting and pytest for both the data pipeline and model serving modules. A green checkmark is required for submission.
  </Step>
</Steps>
