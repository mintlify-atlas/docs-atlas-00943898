---
title: "Drift Monitoring: Detecting Distribution Shift in Spotify Features"
sidebarTitle: "Overview"
description: "Overview of the drift monitoring module — running Kolmogorov-Smirnov tests across 12 Spotify audio features in batch mode (CSV vs CSV) and online mode (CSV vs API logs)."
---
...
Both modes write their results to `drift_report.json`. The report structure is:
