...
description: "Fork the repo, create a solution branch, implement all homework stages, and open a PR against the course repo main branch with a passing CI checkmark."
---
