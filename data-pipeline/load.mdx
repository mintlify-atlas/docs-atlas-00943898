---
title: "load.py: Ingest the Raw Kaggle Spotify Songs Dataset"
sidebarTitle: "Load Stage"
description: "The load stage reads songs.csv from Kaggle and writes data/raw.csv with every column intact. All filtering and splitting happen downstream in process.py."
---
