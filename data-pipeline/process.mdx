...
description: "Splits data/raw.csv into train.csv (year <= 2010) and prod_sim.csv (year > 2010) to create the distribution shift that drift monitoring will detect."
---
