---
title: "GitHub Actions CI: Automated Linting and Testing on Pull Requests"
sidebarTitle: "GitHub Actions"
description: "How the CI pipeline triggers on pull requests, installs all dependencies, runs flake8 linting, and executes pytest on both the data pipeline and model serving test suites."
---
...
The pipeline defines a single job, `test`, with four sequential steps:
...
<Steps>
  ...
  <Step title="Run tests locally">
    ...
    ```
    All 6 tests must pass before you push.
  </Step>
