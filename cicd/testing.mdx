---
title: "Unit Tests: Data Pipeline and Model Serving"
sidebarTitle: "Testing"
description: "Overview of the pytest test suites for the data pipeline and model serving modules — what each test covers, how to run them, and what passing looks like."
---
...
The project uses **flake8** for linting. The configuration in `.flake8` sets `max-line-length = 100` and extends the ignore list with `E203`. Run the linter with:
